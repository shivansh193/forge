    ...
    <main className="min-h-screen flex items-center justify-center px-6 py-16">
      <div className="w-full max-w-[400px]">
        ...
        <div className="border border-line rounded-[16px] bg-surface p-6">
          <h1 className="font-serif italic font-medium text-[26px] text-ink text-center mb-1">Create your workspace</h1>
          <p className="text-[13px] text-ink-faint text-center mb-6">
            Your agents, commit history, and chats — synced to your account.
          </p>

          <form action={formAction} className="flex flex-col gap-4">
            <div>
              <label className="block field-label mb-2 text-[13px]">Name</label>
              <input name="name" type="text" autoComplete="name" placeholder="Ada Lovelace" className={inputClass} />
            </div>
            <div>
        ...
        <p className="text-[13px] text-ink-faint text-center mt-5">
          ...
          <Link href="/auth/sign-in" className="text-accent font-medium">
            Sign in
          </Link>
        </p>
      </div>
